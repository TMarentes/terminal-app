...
![Application gif](docs/app_gif.gif)
...
<b>Python 3.10+: </b> [Python.org](https://www.python.org/downloads/)
...
The following dependencies are automatically installed when running the application:
